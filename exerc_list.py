...
lista_b = [1, 2, 3, 4]
lista_soma = [x + y for x, y in zip(lista_a, lista_b)]  # O zip representa união das duas listas
print(lista_soma)
...
Uma outra possibilidade é usar zip_longest para capturar os
valores da lista maior.
...
valores restantes da lista maior,
